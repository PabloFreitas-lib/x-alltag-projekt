...
```
cd existing_repo
git remote add origin https://gitlab.informatik.uni-bremen.de/pablo2/xalltag.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.informatik.uni-bremen.de/pablo2/xalltag/-/settings/integrations)
